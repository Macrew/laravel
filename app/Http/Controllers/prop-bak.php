...
$html.= '</p>
                 <ul class="button_set">
                        	<li>
                            	<a href="javascript:void(0);" class="open_quicklook"   data-target=".quick-look-modal" data-id = "'.$prop_val['id'].'"><img src="'.url().'/assets/img/quick.png" class="quick-img">Quick View</a>
                            </li>
                            <li>
