            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <?php echo $title; ?>
							<input type="button"  value="Add Page" onclick="window.location.href='<?php echo url(); ?>/admin/ads/create'"class="btn btn-primary add_button">
                        </div>
                        <!-- /.panel-heading -->
				...
				?>
										...
										<tr>
											...
											?></td>
                                            <td><button class="btn btn-primary btn-mini" onclick="window.location.href='<?php echo url(); ?>/admin/ads/change_ads_status/<?php echo $ads_val['id']; ?>/<?php echo $ads_val['status']; ?>'"><?php  if($ads_val['status']  == 'Unpublish') { ?><i class="fa fa-times"></i> <?php } else { ?><i class="fa fa-check"></i><?php } ?></button> 
											</td>
