...
<?php if(Session::has('update_message')) { ?>
	...
	<?php } ?>
            ...
            <div class="row">
                    ...
                    <div class="panel panel-default">
						...
						list($controller, $method) = explode('@', $currentAction);
						 ...
						 $method = preg_replace('/.*\\\/', '', $method);
						  if($controller == 'PropertyController' && $method == 'edit_gallery') {
						$property_arr = $prop_arr[0];
						echo $property_arr['property_title'].' '.'Gallery Images';
						?>
								<input type="button" style="margin-left: 700px;" value="Add More Images" onclick="window.location.href='<?php echo url(); ?>/admin/property/gallery/add_gallery_images/<?php echo $property_arr['id']; ?>'" class="btn btn-primary">
								<button type="button" onclick="window.location.href='<?php echo url(); ?>/admin/property/sort_gallery/<?php echo $id ;  ?>'"class="btn btn-primary">Sort Gallery Properties</button>

						<?php
						
						} else if($controller == 'PropertyController' && $method == 'add_more_images') {
							echo $title; ?>
							
								<input type="button" style="margin-left: 700px;" value="Back" onclick="window.location.href='<?php echo url(); ?>/admin/property/gallery/edit/<?php echo $propid; ?>'" class="btn btn-primary">
				...
				?>
						...
						<?php } else if($controller == 'PropertyController' && $method == 'create_gallery') { ?>
						  <div class="panel-body">
						<?php 
						/*  echo '<pre>';
						print_r($builders_arr); 
  ...
  border:none !important;">
						...
						<?php }  else if($controller == 'PropertyController' && $method == 'add_more_images') { ?>
  ...
  border:none !important;">
    ...
    $(document).ready(function() {
	 $('#properties').DataTable({
		 ...
		 $('.builder').on('change',function(){
			...
			$.ajax({
			url: '<?php echo url(); ?>/admin/property/gallery/ajax_builder_properties',
	...
	<?php  if($controller == 'PropertyController' && $method == 'create_gallery') { ?>
