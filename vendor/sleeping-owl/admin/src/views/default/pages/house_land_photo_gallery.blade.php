            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                           <?php echo $title; ?>
							<input type="button"  value="Add Gallery" onclick="window.location.href='<?php echo url(); ?>/admin/house-and-land/gallery/create'"class="btn btn-primary add_button">
                        </div>
				...
				?>
										...
										<tr>
                                            ...
                                            <td><button class="btn btn-primary btn-mini" onclick="window.location.href='<?php echo url(); ?>/admin/house-and-land/gallery/edit/<?php echo $properties_val['id']; ?>'"><i class="icon-pencil icon-white"></i>Edit</button> 
											</td>
