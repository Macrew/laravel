	...
	<?php } ?>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
						...
						<?php // echo Route::getCurrentRoute()->getActionName(); 
						 ...
						 if($controller == 'CategoryController' && $method == 'edit_parnter') {
						...
						?>
                                    <form method="post" action="<?php echo url(); ?>/admin/partner/update/<?php echo $partner_arr['partner_id']; ?>" enctype="multipart/form-data">
									 <input type="hidden" name="_token" value="<?php echo csrf_token() ; ?>">
										 <div class="form-group">
                                            <label>Firstname</label>
                                           <input placeholder="Enter firstname" class="form-control" value="<?php if(!empty($partner_arr['firstname'])) { echo $partner_arr['firstname'] ; } ?>" name="firstname" type="text">
                                        </div>
										 <div class="form-group">
                                            <label>Lastname</label>
                                           <input placeholder="Enter lastname" class="form-control" value="<?php if(!empty($partner_arr['lastname'])) { echo $partner_arr['lastname'] ; } ?>" name="lastname" type="text">
                                        </div>
                                        <div class="form-group">
                                            <label>Address</label>
                                            <textarea rows="3" class="form-control" name="address"><?php if(!empty($partner_arr['address'])) { echo $partner_arr['address'] ; } ?></textarea>
                                        </div>
										 <div class="form-group">
                                            <label>Company Name</label>
                                             <input placeholder="Enter company name" class="form-control" value="<?php if(!empty($partner_arr['company_name'])) { echo $partner_arr['company_name'] ; } ?>" name="company_name" type="text">
                                        </div>
										<div class="form-group">
                                            <label>Phone Number</label>
                                             <input placeholder="Enter phone number" class="form-control" value="<?php if(!empty($partner_arr['phn_no'])) { echo $partner_arr['phn_no'] ; } ?>" name="phn_no" type="text">
                                        </div>
                                        <div class="form-group">
										...
										<div class="form-group">
										<?php if(!empty($partner_arr['logo'])) {   ?>
                                            <label>Image</label>
                                            <img src="<?php echo url(); ?>/uploads/partner_logo/<?php echo $partner_arr['logo'];  ?>"  width="50" height="50"/>
										<?php } ?>
                                        </div>
                                        <div class="form-group">
                                            <label>History/Description</label>
                                            <textarea rows="3" class="form-control" id="desc" name="partner_desc"><?php if(!empty($partner_arr['partner_desc'])) { echo $partner_arr['partner_desc'] ; } ?></textarea>
											 <script>
                ...
                CKEDITOR.replace('desc');
										...
										<div class="form-group">
                                            <label>Established Year</label>
                                             <input placeholder="Enter Established Year" class="form-control" value="<?php if(!empty($partner_arr['established'])) { echo $partner_arr['established'] ; } ?>" name="established" type="text">
                                        </div>

                                        <div class="form-group">
                                            <label>Link of Category Partner</label>
                                             <input placeholder="Enter Link of partner" class="form-control" value="<?php if(!empty($partner_arr['link'])) { echo $partner_arr['link'] ; } ?>" name="link" type="text">
                                        </div>
						...
						<?php } else if($controller == 'CategoryController' && $method == 'create_partner') { ?>
						  <div class="panel-body">
						<?php 
						/*  echo '<pre>';
						print_r($landestate_arr); 
                ...
                CKEDITOR.replace('desc');
                                        ...
                                        <div class="form-group">
                                            <label>Link of Category Partner</label>
                                             <input placeholder="Enter Link of partner" class="form-control" value="<?php if(!empty(Input::old('link'))) { echo Input::old('link') ; }  ?>" name="link" type="text">
                                        </div>
