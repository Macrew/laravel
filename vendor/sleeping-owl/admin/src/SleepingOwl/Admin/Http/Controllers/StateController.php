...
class StateController extends Controller
{
	...
	{
		$state = State::groupBy('state_name')->get();    
		$data['states_arr'] = $state->toArray();
		$data['title'] = "States Visibilty";
		return view(AdminTemplate::view('pages.statesvisibilty'), $data);
	}
	
	public function change_visibilty($state_name,$status)
	{
		if($status == 'yes') {
			DB::table('states')
