            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
						...
						?>
						<input type="button" style="margin-left: 700px;" value="Add More Images" onclick="window.location.href='<?php echo url(); ?>/admin/property/gallery/add_gallery_images/<?php echo $id; ?>'" class="btn btn-primary" style='float:right;'>							
                        </div>
