...
@section('content')
            ...
            <div class="row">
				...
				?>
										...
										<tr>
                                            ...
                                            <td><button class="btn btn-primary btn-mini" onclick="window.location.href='<?php echo url(); ?>/admin/builder/edit/<?php echo $build_val['builders']['builder_id']; ?>'"><i class="icon-pencil icon-white"></i>Edit</button> 
											<button class="btn btn-danger btn-mini" onclick="javascript:delete_builder(<?php echo $build_val['builders']['builder_id'] ;  ?>)" ><i class="icon-remove icon-white"></i>Delete</button>
	...
	function delete_builder(builder_id)
	{
		if(builder_id)
		{
			var status = confirm('Are you sure you want to delete builder details.');
			if(status)
			{
