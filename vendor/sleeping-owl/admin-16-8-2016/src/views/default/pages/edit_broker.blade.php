	...
	<?php } ?>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
						...
						list($controller, $method) = explode('@', $currentAction);
						 ...
						 if($controller == 'BrokerController' && $method == 'edit_broker') {
						...
						?>
                                    <form method="post" action="<?php echo url(); ?>/admin/broker/update/<?php echo $landestate_arr['broker_id']; ?>" enctype="multipart/form-data">
                ...
                CKEDITOR.replace('desc');
						...
						<?php } else if($controller == 'BrokerController' && $method == 'create_broker') { ?>
						  <div class="panel-body">
						<?php 
						/*  echo '<pre>';
						print_r($landestate_arr); 
						...
						?>
                                    <form method="post" action="<?php echo url(); ?>/admin/broker/add" enctype="multipart/form-data">
									 <input type="hidden" name="_token" value="<?php echo csrf_token() ; ?>">
									 	<div class="form-group">
                                            <label>Email</label>
                                        ...
                                        <div class="form-group">
                                            <label>Upload Logo</label>
                                            <input type="file" name="broker_logo">
											
                                        </div>
                                        <div class="form-group">
                                            <label>History/Description</label>
                                            <textarea rows="3" class="form-control" id="desc" name="broker_desc"><?php if(!empty(Input::old('broker_desc'))) { echo Input::old('broker_desc') ; }  ?></textarea>
											 <script>
                // Replace the <textarea id="editor1"> with a CKEditor
                // instance, using default configuration.
                CKEDITOR.replace('desc');
