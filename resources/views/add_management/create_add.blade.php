...
<section class="main_con sub-main">	
       <div class="container">
           <div class="sub-heading"><h1>Create Ad</h1></div>
           <div class="addproperty-heading">
				<input type="button" class="btn btn-primary" onclick="window.location.href='{{ url('addmanagement') }}'" value="Back to Ad management" style='border-radius:unset;padding:13px;'>
			</div>
           <div class="create-ad">
