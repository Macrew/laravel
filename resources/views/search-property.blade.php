...
<div class="content">
    <div class="search_page container">
		...
		?>
            <div class="featured-box search-featured-box">
                <div class="featured-image">
                    <div class="featured-strip">
						...
						<img src="<?php echo url(); ?>/assets/images/featured-strip-icon3.png" id="compare_src_<?php echo $prop_val['id']; ?>" alt="featured" /><?php } ?><span id="save_text_<?php echo $prop_val['id']; ?>"></span><span>Compare</span></a>
				...
				<?php  $check_save_prop =  App\Models\SaveProperty::check_new_save_prop($prop_val['id']) ;  ?>
					...
					if(!empty($prop_val['property_gallery'])) {
						foreach($prop_val['property_gallery'] as $prop_img) {
							...
							echo '<a href="'.url().'/propertydetail/'.$prop_val['id'].'"><img class="img-full" src="'.url().'/public/timthumb.php?src=/uploads/property_gallery/'.$prop_img['image'].'&h=400&w=700&q=100" class="gal_img" /></a>';
						}
			...
			<?php } } else {  echo '<h2>No results</h2><br/><p>There are no products matching your search criteria. Try making your filters less specific.</p>' ;  } ?>
<div class="clr"></div>
<ul class="pagination">
		<?php 
