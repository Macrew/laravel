...
<section class="plist_main"><!--property section!-->
    	...
    	<div class="filter_sec">
            ...
            <div class="range_sec"><!--range bar!-->
				...
				<input type="hidden" name="filter_max_hsize" value="" id="filter_max_hsize" />
			     ...
			     <div class="range_sec"><!--range bar!-->
            	<h4><i class="fa fa-arrows-alt"></i> Land size</h4>
    ...
    <div class="list_mid"><!--middle section!-->
    	<div class="white_mid"><!--white box!-->
        	<div class="t_listleft"><span class="prop_count"><?php if(!empty($total_prop)) { echo $total_prop ; } else { echo '0' ; } ?></span> House & Land Packages</div>
        ...
        <div class="grey_bg"><!--white box!-->
            ...
            <div class="model_right model_right_house"><!--right section!-->
				...
				<p><?php  echo $prop_val['house_land_address'] ; ?></p>
				...
				<span class="length">House: <?php echo $prop_val['housesize'] ;?>sqm | Land: <?php echo $prop_val['land_size'] ;?>sqm</span>
...
echo $string; ; } ?> </p>
                 <ul class="button_set">
                        	<li>
						<a href="javascript:void(0);" class="open_quicklook"   data-target='.quick-look-modal' data-id = '<?php echo $prop_val['id']; ?>'><img src="{{ URL::asset('assets/img/quick.png') }}" class="quick-img">Quick look</a>
                            </li>
                            <li>
