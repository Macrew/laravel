...
<section class="main_con">
       <div class="container property_manag">
           <div class="sub-heading"><h1>House and Land</h1></div>
			<div class='dataTable_wrapper'>
				<div class="addproperty-heading">
					...
					<input type="button" class="btn btn-primary" onclick="window.location.href='{{ url('builder/house-and-land/add') }}'" value="Add House and land">
				</div>
					...
					<tbody>
						...
						foreach($property as $val){ 
						 ...
						 <tr>
							 ...
							 <td><a href="<?php echo url(); ?>/builder/house-and-land/view/<?php echo $val->id; ?>"><img src="{{ URL::asset('assets/img/view_prop.png') }}" alt="edit"></a><a href="<?php echo url(); ?>/builder/house-and-land/edit/<?php echo $val->id; ?>"><img src="{{ URL::asset('assets/img/edit-green.png') }}" alt="close"></a><a href='<?php echo url(); ?>/builder/house-and-land/delete/<?php echo $val->id; ?>' onclick="return confirm(' you want to delete?');"><img src="{{ URL::asset('assets/img/close-red.png') }}" alt="close"></a></td>
						 </tr>
					   <?php }
					   }else{
							echo '<tr><td>No House and Land found. Please add House and Land.</td></tr>';
					   } ?>
					 </tbody>
			   </table>
